...
for bm in ${benchmarks[@]}; do
    ...
    export PAPI_OUTPUT_DIRECTORY=${PWD}/../eight-core/npb/$bm/backend0_data
    echo "backend0"
    ...
    export PAPI_OUTPUT_DIRECTORY=${PWD}/../eight-core/npb/$bm/backend1_data
    echo "backend1"
    numactl --physcpubind=0,1,2,3,4,5,6,7 --membind=0 -- ./bin/$bm
    export PAPI_EVENTS="PAPI_L1_ICM,PAPI_L1_ICH,PAPI_L1_ICA,PAPI_TLB_IM"
    export PAPI_OUTPUT_DIRECTORY=${PWD}/../eight-core/npb/$bm/frontend_data
    echo "frontend"
    numactl --physcpubind=0,1,2,3,4,5,6,7 --membind=0 -- ./bin/$bm
    export PAPI_EVENTS="PAPI_TOT_INS,PAPI_INT_INS,PAPI_FP_INS,PAPI_LD_INS"
    export PAPI_OUTPUT_DIRECTORY=${PWD}/../eight-core/npb/$bm/inst0_data
    echo "inst0"
    numactl --physcpubind=0,1,2,3,4,5,6,7 --membind=0 -- ./bin/$bm
    export PAPI_EVENTS="PAPI_SR_INS,PAPI_BR_INS,PAPI_VEC_INS"
    export PAPI_OUTPUT_DIRECTORY=${PWD}/../eight-core/npb/$bm/inst1_data
    echo "inst1"
    numactl --physcpubind=0,1,2,3,4,5,6,7 --membind=0 -- ./bin/$bm
    export PAPI_EVENTS="PAPI_STL_ICY,PAPI_STL_CCY,PAPI_BR_MSP,PAPI_BR_PRC,PAPI_RES_STL,PAPI_TOT_CYC,PAPI_LST_INS"
    export PAPI_OUTPUT_DIRECTORY=${PWD}/../eight-core/npb/$bm/pipe0_data
    echo "pipe0"
    numactl --physcpubind=0,1,2,3,4,5,6,7 --membind=0 -- ./bin/$bm
    export PAPI_EVENTS="PAPI_SYC_INS,PAPI_FP_OPS,PAPI_REF_CYC"
    export PAPI_OUTPUT_DIRECTORY=${PWD}/../eight-core/npb/$bm/pipe1_data
    echo "pipe1"
    numactl --physcpubind=0,1,2,3,4,5,6,7 --membind=0 -- ./bin/$bm
done
